...
\caption{\label{tab:Fig2 Prep Table 1}Estimated Cancer Succeptibilty for nodes in Atlantogenata}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:Figure3 Prep Genome Table}Summary of duplications in Atlantogenata}
\centering
\resizebox{\linewidth}{!}{
...
\subsection{Duplications that occurred recently in Probodiscea are
enriched for tumor suppressor
pathways}\label{duplications-that-occurred-recently-in-probodiscea-are-enriched-for-tumor-suppressor-pathways}}

\begin{table}

\caption{\label{tab:Branches which experienced an increase in size}Number of pathways overrepresented among duplicated genes at different FDRs.}
\centering
\resizebox{\linewidth}{!}{
...
\addcontentsline{toc}{subsection}{Concerted duplication of TP53 and
TP53-related genes towards \emph{Probodiscea}}
